<?php
/*
	Plugin Name: Savoy Theme - Post Social Share
	Plugin URI: http://themeforest.net/item/savoy-minimalist-ajax-woocommerce-theme/12537825
	Description: Social share buttons for blog posts.
	Version: 1.0
	Author: NordicMade
	Author URI: http://www.nordicmade.com
	Text Domain: nm-post-social-share
...
/*
 *  Post: Include social share buttons
 */
function nm_post_social_share() {
    global $post;
...
add_action( 'nm_after_post', 'nm_post_social_share' );
