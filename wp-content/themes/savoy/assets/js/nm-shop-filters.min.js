...
shopFiltersBind:function(){var a=this;if(a.filtersEnableAjax)a.$header.on("click.nmHeaderShopAjax",".shop-ajax-link",function(b){b.preventDefault();var h=c(this),g=h.parents(".menu-item").last();g.addClass("no-hover");a.shopFiltersSearchClose();c("#nm-shop-categories").children(".current-cat").removeClass("current-cat");b=a.shopScrollToTop();setTimeout(function(){a.shopGetPage(h.children("a").attr("href"));setTimeout(function(){g.removeClass("no-hover")},100)},b)});a.$shopFilterMenu.find("a").on("click",
function(b){b.preventDefault();if(!a.filterPanelSliding){a.shopRemoveNotices();a.filterPanelSliding=!0;b=0;var h=c(this).parent("li"),g=h.data("panel");h.hasClass("active")||(b=a.shopFiltersHideActivePanel());h.toggleClass("active");setTimeout(function(){a[a.shopFilterMenuFnNames[g]]()},b)}});if(a.filtersEnableAjax&&a.$pageIncludes.hasClass("shop_categories"))a.$shopWrap.on("click","#nm-shop-categories a",function(b){b.preventDefault();b=c(this);var h=b.parent("li");a.shopFiltersSearchClose();c("#nm-shop-categories").children(".current-cat").removeClass("current-cat");
